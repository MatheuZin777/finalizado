    ...
    <div class="container">
        <div class="form-section">
            ...
            <form action="pagar.php" method="POST">
                ...
                <div class="form-group">
                    <p class="total-price">Total: R$ <span id="total-price">1.299</span></p>
        ...
        <div class="image-section">
            <div class="carousel">
                <div class="carousel-images" id="carousel-images">
                    <img src="../mzun.png" alt="Imagem 1">
                    <img src="../cima.png" alt="Imagem 2">
                    <img src="../atras.png" alt="Imagem 3">
                    <img src="../baixo.png" alt="Imagem 4">
                </div>
            ...
            <div class="product-description">
                ...
                <p>
                    O tênis da Mizuno que te acompanha em todas as suas atividades. A sua entressola possui a tecnologia
                    Infinity Wave em toda a sua extensão dando a ele um visual moderno e tecnológico. O seu cabedal é
                    feito de um tecido que proporciona maior respirabilidade e ajuste aos seus pés. Além disso, seu
                    solado tem a tecnologia X10, um composto de borracha com carbono que garante maior durabilidade.
                </p>
            </div>
        </div>
    </div>
